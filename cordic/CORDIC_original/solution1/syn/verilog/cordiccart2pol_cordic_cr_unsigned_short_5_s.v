...
reg   [10:0] tmp_reg_184;
reg   [10:0] r_V_reg_189;
reg    ap_block_state1;
wire    ap_CS_fsm_state2;
wire   [15:0] y_sft_V_fu_70_p7;
wire   [15:0] sub_ln859_fu_83_p2;
wire   [15:0] add_ln859_fu_88_p2;
wire  signed [15:0] sext_ln1534_fu_80_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ...
        r_V_reg_189 <= {{p_read[15:5]}};
        tmp_reg_184 <= {{p_read1[15:5]}};
    end
end
...
assign add_ln859_3_fu_100_p2 = ($signed(sext_ln1534_fu_80_p1) + $signed(p_read1));

assign add_ln859_4_fu_132_p2 = (select_ln859_4_fu_124_p3 + p_read2);

assign add_ln859_fu_88_p2 = (y_sft_V_fu_70_p7 + p_read);
...
assign sext_ln1534_fu_80_p1 = $signed(r_V_reg_189);

assign sub_ln859_2_fu_105_p2 = ($signed(p_read1) - $signed(sext_ln1534_fu_80_p1));

assign sub_ln859_fu_83_p2 = (p_read - y_sft_V_fu_70_p7);

assign tmp_13_fu_117_p3 = p_read1[32'd15];

assign y_sft_V_fu_70_p7 = {{{{{{p_Repl2_s_reg_173}, {p_Repl2_s_reg_173}}, {p_Repl2_s_reg_173}}, {p_Repl2_s_reg_173}}, {p_Repl2_s_reg_173}}, {tmp_reg_184}};
