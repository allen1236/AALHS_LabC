...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ...
        r_V_reg_186 <= {{p_read[15:6]}};
        tmp_reg_191 <= {{p_read1[15:6]}};
    end
end
...
assign add_ln859_1_fu_101_p2 = ($signed(sext_ln1534_fu_70_p1) + $signed(p_read1));

assign add_ln859_2_fu_133_p2 = (select_ln859_2_fu_125_p3 + p_read2);

assign add_ln859_fu_89_p2 = (y_sft_V_fu_73_p8 + p_read);
...
assign sext_ln1534_fu_70_p1 = $signed(r_V_reg_186);

assign sub_ln859_1_fu_106_p2 = ($signed(p_read1) - $signed(sext_ln1534_fu_70_p1));

assign sub_ln859_fu_84_p2 = (p_read - y_sft_V_fu_73_p8);

assign tmp_11_fu_118_p3 = p_read1[32'd15];

assign y_sft_V_fu_73_p8 = {{{{{{{p_Repl2_s_reg_174}, {p_Repl2_s_reg_174}}, {p_Repl2_s_reg_174}}, {p_Repl2_s_reg_174}}, {p_Repl2_s_reg_174}}, {p_Repl2_s_reg_174}}, {tmp_reg_191}};
