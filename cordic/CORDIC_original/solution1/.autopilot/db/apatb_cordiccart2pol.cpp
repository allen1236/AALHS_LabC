...
aesl_fh.write(AUTOTB_TVIN_r, formatData(pos, 32));
}
...
aesl_fh.write(AUTOTB_TVIN_theta, formatData(pos, 32));
}
...
{
auto *pos = (unsigned char*)__xlx_apatb_param_r;
aesl_fh.write(AUTOTB_TVOUT_r, formatData(pos, 32));
}
  tcl_file.set_num(1, &tcl_file.r_depth);
...
{
auto *pos = (unsigned char*)__xlx_apatb_param_theta;
aesl_fh.write(AUTOTB_TVOUT_theta, formatData(pos, 32));
}
  tcl_file.set_num(1, &tcl_file.theta_depth);
