...
# 4 "./cordiccart2pol.h" 2
# 1 "E:/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot\\ap_fixed.h" 1
# 55 "E:/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot\\ap_fixed.h"
...
# 56 "E:/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot\\ap_fixed.h" 2
...
# 57 "E:/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot\\ap_int.h"
...
typedef ap_fixed<16, 3, AP_RND_CONV> data_comp_t;
typedef ap_fixed<16 +9, 3 +9> data_sgn_ext;
...
static data_comp_t cordic_phase[14] = {2.001, 0.4636476090008061, 0.24497866312686414, 0.12435499454676144, 0.06241880999595735, 0.031239833430268277, 0.015623728620476831, 0.007812341060101111, 0.0039062301319669718, 0.0019531225164788188, 0.0009765621895593195, 0.0004882812111948983, 0.00024414062014936177, 0.00012207031189367021};
...
void cordic_cr(data_comp_t x, data_comp_t y, data_comp_t theta, data_comp_t &x_nxt, data_comp_t &y_nxt, data_comp_t &theta_nxt, data_idx cordic_iter)
{
 ...
 data_sgn_ext y_sgn;
 y_sgn.range(16 -1, 0) = y.range(16 -1, 0);
 SGN_PADDING:
 for(short j=16; j<16 +9; j++)
 {
#pragma HLS UNROLL
 y_sgn[j] = y[16 -1];
 }
 ...
 x_nxt = (y[16 -1])? x-y_sft : x+y_sft;
 y_nxt = (y[16 -1])? y+x_sft : y-x_sft;
 theta_nxt = (y[16 -1])? theta - cordic_phase[cordic_iter] : theta + cordic_phase[cordic_iter];

}
# 99 "cordiccart2pol.cpp"
__attribute__((sdx_kernel("cordiccart2pol", 0))) void cordiccart2pol(data_t x, data_t y, data_t * r, data_t * theta)
{
#line 15 "D:/Documents/HLS/LabC/cordic_orig-20221113T132330Z-001/cordic_orig/CORDIC_original/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=cordiccart2pol
# 100 "cordiccart2pol.cpp"

#line 6 "D:/Documents/HLS/LabC/cordic_orig-20221113T132330Z-001/cordic_orig/CORDIC_original/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=cordiccart2pol
# 100 "cordiccart2pol.cpp"
...
#pragma HLS DATAFLOW
 ...
 ap_ufixed<10, 0> K = 0.858787520484;
 static data_comp_t x_pip[9], y_pip[9], theta_pip[9];

 inStream_x << x;
 inStream_y << y;

 ini_trans(inStream_x, inStream_y, x_pip[0], y_pip[0], theta_pip[0]);
# 145 "cordiccart2pol.cpp"
 ...
 outStream_theta << (theta_pip[8 -1] + y_pip[8 -1]);
 outStream_r << (x_pip[8 -1] * K);
