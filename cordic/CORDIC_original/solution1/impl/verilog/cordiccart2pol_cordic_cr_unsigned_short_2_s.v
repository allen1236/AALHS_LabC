...
reg   [13:0] tmp_reg_178;
reg   [13:0] r_V_reg_183;
reg    ap_block_state1;
wire    ap_CS_fsm_state2;
wire   [15:0] y_sft_V_fu_70_p4;
wire   [15:0] sub_ln859_fu_80_p2;
wire   [15:0] add_ln859_fu_85_p2;
wire  signed [15:0] sext_ln1534_fu_77_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        ...
        r_V_reg_183 <= {{p_read[15:2]}};
        tmp_reg_178 <= {{p_read1[15:2]}};
    end
end
...
assign add_ln859_9_fu_97_p2 = ($signed(sext_ln1534_fu_77_p1) + $signed(p_read1));

assign add_ln859_fu_85_p2 = (y_sft_V_fu_70_p4 + p_read);
...
assign sext_ln1534_fu_77_p1 = $signed(r_V_reg_183);

assign sub_ln859_5_fu_102_p2 = ($signed(p_read1) - $signed(sext_ln1534_fu_77_p1));

assign sub_ln859_fu_80_p2 = (p_read - y_sft_V_fu_70_p4);

assign tmp_19_fu_114_p3 = p_read1[32'd15];

assign y_sft_V_fu_70_p4 = {{{p_Repl2_s_reg_170}, {p_Repl2_s_reg_170}}, {tmp_reg_178}};
