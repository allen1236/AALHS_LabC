; ModuleID = 'D:/Documents/HLS/LabC/Big_Data_Ser/baseline/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %src_buff_copy = bitcast i8* %malloccall to [660000 x i8]*
  %malloccall1 = tail call i8* @malloc(i64 660000)
  %dst_buff_copy = bitcast i8* %malloccall1 to [660000 x i8]*
  %0 = bitcast i8* %src_buff to [660000 x i8]*
  %1 = bitcast i8* %dst_buff to [660000 x i8]*
  call fastcc void @copy_in([660000 x i8]* nonnull %0, [660000 x i8]* %src_buff_copy, [660000 x i8]* nonnull %1, [660000 x i8]* %dst_buff_copy)
  call void @apatb_dut_hw(i8* %malloccall, i32 %src_sz, i8* %malloccall1)
  call void @copy_back([660000 x i8]* %0, [660000 x i8]* %src_buff_copy, [660000 x i8]* %1, [660000 x i8]* %dst_buff_copy)
