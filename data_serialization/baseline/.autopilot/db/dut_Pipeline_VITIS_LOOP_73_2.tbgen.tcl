set moduleName dut_Pipeline_VITIS_LOOP_73_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dut_Pipeline_VITIS_LOOP_73_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ next_col_idx_V int 3 regular  }
	{ gmem int 8 regular {axi_master 2}  }
	{ sub int 29 regular  }
	{ ptr_col int 32 regular {array 7 { 2 3 } 1 1 }  }
	{ dst_buff int 64 regular  }
	{ src_buff int 64 regular  }
	{ ptr_col2 int 32 regular {array 7 { 2 3 } 1 1 }  }
	{ ptr_col2_base int 32 regular {array 7 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "next_col_idx_V", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ptr_col2", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "ptr_col2_base", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ next_col_idx_V sc_in sc_lv 3 signal 0 } 
	{ sub sc_in sc_lv 29 signal 2 } 
	...
	{ ptr_col2_address0 sc_out sc_lv 3 signal 6 } 
	{ ptr_col2_ce0 sc_out sc_logic 1 signal 6 } 
	{ ptr_col2_we0 sc_out sc_logic 1 signal 6 } 
	{ ptr_col2_d0 sc_out sc_lv 32 signal 6 } 
	{ ptr_col2_q0 sc_in sc_lv 32 signal 6 } 
	{ ptr_col2_base_address0 sc_out sc_lv 3 signal 7 } 
	{ ptr_col2_base_ce0 sc_out sc_logic 1 signal 7 } 
	{ ptr_col2_base_q0 sc_in sc_lv 32 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "next_col_idx_V", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "next_col_idx_V", "role": "default" }} , 
 	...
 	{ "name": "ptr_col2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ptr_col2", "role": "q0" }} , 
 	...
 	{ "name": "ptr_col2_base_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ptr_col2_base", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	next_col_idx_V { ap_none {  { next_col_idx_V in_data 0 3 } } }
	...
	ptr_col { ap_memory {  { ptr_col_address0 mem_address 1 3 }  { ptr_col_ce0 mem_ce 1 1 }  { ptr_col_we0 mem_we 1 1 }  { ptr_col_d0 mem_din 1 32 }  { ptr_col_q0 mem_dout 0 32 } } }
	dst_buff { ap_none {  { dst_buff in_data 0 64 } } }
	src_buff { ap_none {  { src_buff in_data 0 64 } } }
	ptr_col2 { ap_memory {  { ptr_col2_address0 mem_address 1 3 }  { ptr_col2_ce0 mem_ce 1 1 }  { ptr_col2_we0 mem_we 1 1 }  { ptr_col2_d0 mem_din 1 32 }  { ptr_col2_q0 mem_dout 0 32 } } }
	ptr_col2_base { ap_memory {  { ptr_col2_base_address0 mem_address 1 3 }  { ptr_col2_base_ce0 mem_ce 1 1 }  { ptr_col2_base_q0 in_data 0 32 } } }
}
